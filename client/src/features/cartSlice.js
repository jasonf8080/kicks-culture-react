...
const cart = createSlice({
    ...
    reducers: {
      ...
      clearItemAdded: (state, action) => {
        state.itemAdded = null
      }
    }, 
    ...
    extraReducers:{
        ...
        [getCartItem.fulfilled]: (state, action) => {
            ...
            state.itemAdded = action.payload.cartItem
        },

        // [checkIfItemAdded.fulfilled]: (state, action) => {
        //     const [duplicateItem] = action.payload
        //     state.duplicateItem = duplicateItem;
        // },
...
export const {clearSizeMsg, clearItemAdded} = cart.actions;
